...
beautiful.init("/home/aziz/.config/awesome/themes/zenburn/theme.lua")
...
cpuicon:set_image(awful.util.getdir("config") .. "/themes/zenburn/icons/cpu.png")
-- Initialize widget
...
memicon:set_image(awful.util.getdir("config") .. "/themes/zenburn/icons/mem.png")
-- Initialize widget
memwidget = wibox.widget.textbox()
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, "MEM: $1%", 7)

-- Network Usage widget : Initialise and Register widget
dnicon = wibox.widget.imagebox()
upicon = wibox.widget.imagebox()
dnicon:set_image(awful.util.getdir("config") .. "/themes/zenburn/icons/down.png")
upicon:set_image(awful.util.getdir("config") .. "/themes/zenburn/icons/up.png")
wifilabel = wibox.widget.textbox()
wifilabel:set_text('WiFi: ')
wifiwidget = wibox.widget.textbox()
vicious.register(wifiwidget, vicious.widgets.net, '${wlp3s0 down_kb} ${wlp3s0 up_kb}', 3)
ethlabel = wibox.widget.textbox()
ethlabel:set_text('ETH: ')
ethwidget = wibox.widget.textbox()
vicious.register(ethwidget, vicious.widgets.net, '${enp0s25 down_kb} ${enp0s25 up_kb}', 3)


seperator = wibox.widget.imagebox()
seperator:set_image(awful.util.getdir("config") .. "/themes/zenburn/icons/separator.png")
...
mypowerlauncher = awful.widget.launcher({ image = awful.util.getdir("config") .. "/themes/zenburn/icons/power.png",
                                          menu = mypowermenu })
...
for s = 1, screen.count() do
    ...
    right_layout:add(wifilabel)
    right_layout:add(dnicon)
    right_layout:add(wifiwidget)
    right_layout:add(upicon)

    right_layout:add(ethlabel)
    right_layout:add(dnicon)
    ...
    bottom_right_layout:add(mypowerlauncher)
